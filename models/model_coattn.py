...
class MCAT_Surv(nn.Module):
    def __init__(self, fusion='concat', omic_sizes=[100, 200, 300, 400, 500, 600], n_classes=4,
        ...
        self.size_dict_WSI = {"small": [feature_size, 256, 256], "big": [feature_size, 512, 384]} #resnet:1024, ctranspath 768
        self.size_dict_omic = {'small': [256, 256], 'big': [feature_size, 1024, 1024, 256]}
